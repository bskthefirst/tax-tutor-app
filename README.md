...
- `TAX_TUTOR_OPENCODE_MODEL`: optional OpenCode model id (defaults to `opencode/qwen3.6-plus-free`)
- `MOONSHOT_API_KEY`: optional direct Moonshot provider key fallback
- `MOONSHOT_URL`: optional direct Moonshot base URL fallback (defaults to `https://api.moonshot.ai/v1`)
- `MOONSHOT_MODEL`: optional direct Moonshot model fallback (defaults to `kimi-k2.6`)
